...
class Placement extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        // $orderModel = $simiObjectManager->create('Magento\Sales\Model\Order')
        //                     ->loadByIncrementId($this->getRequest()->getParam('orderNumber'));
        $checkoutSession->setLastRealOrderId($this->getRequest()->getParam('orderNumber'));

        $this->_redirect('ipay88/payment/redirect');
    }
}
