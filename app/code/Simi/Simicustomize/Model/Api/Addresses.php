...
class Addresses extends Apiabstract
{
    ...
    {
        $data               = $this->getData();
        $address            = $this->simiObjectManager->get('Simi\Simicustomize\Model\Address')->saveAddress($data);
    ...
    public function index()
    {
        ...
        foreach ($addresses as $index => $address) {
            ...
            $addresses[$index] = array_merge($address, $this->simiObjectManager
                    ->get('Simi\Simicustomize\Helper\Address')->getAddressDetail($addressModel, $customer));
        }
    ...
    public function show()
    {
        ...
        if ($data['resourceid']) {
            if ($data['resourceid'] == 'geocoding') {
                ...
                $dataresult    = $this->simiObjectManager->get('Simi\Simicustomize\Helper\Address')
