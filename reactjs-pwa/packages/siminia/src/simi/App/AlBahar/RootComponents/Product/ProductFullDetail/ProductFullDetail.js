...
import {analyticAddCartGTM} from '../../../Helper/Analytics'
...
class ProductFullDetail extends Component {
    ...
    get isMissingConfigurableOptions() {
        ...
        const numProductOptions = configurable_options && configurable_options.length;
    ...
    render() {
        ...
        const addCartButton = (<SimiMutation mutation={mutationType} key={Identify.randomString(3)}>
            {(addProductCall, { data, error }) => {
                ...
                if (data) {
                    analyticAddCartGTM(product, this.quantity)
        ...
        return (
            <div className="container product-detail-root">
                ...
                <div className="main-actions">
                    ...
                    <AddToWishlist params={this.prepareParams()} toggleMessages={toggleMessages} />
