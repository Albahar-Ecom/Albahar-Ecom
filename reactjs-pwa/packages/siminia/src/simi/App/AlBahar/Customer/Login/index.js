...
import { useSignIn } from 'src/simi/App/AlBahar/talons/SignIn/useSignIn';
...
import { SIGN_IN_SOCIAL_MUTATION } from './signInSocial.gql';
...
const Login = props => {
    ...
    const talonProps = useSignIn({
        ...
        signInSocialMutation: SIGN_IN_SOCIAL_MUTATION,
        mergeCartsMutation
    });
    ...
    const signInForm = () => {
        ...
        return (
            <div className={className}>
                <SignIn 
                    showCreateAccountForm={() => setTabOpen(2)} 
                    onForgotPassword={() => setTabOpen(3)} 
