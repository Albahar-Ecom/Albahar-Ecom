    ...
    renderView=()=>{
        ...
        if (this.prices.has_special_price) {
            if (this.prices.show_ex_in_price !== null && this.prices.show_ex_in_price === 1) {
                special_price_label = (<div className="speical-price-value">{this.prices.special_price_label}</div>);
                price_excluding_tax = (
            ...
            if (this.prices.show_ex_in_price !== null && this.prices.show_ex_in_price === 1) {
                ...
                price = (
                    <div className="price-value">
                        <span className="as-low-as">{Identify.__("As low as")}</span>
                        <span className="price-label">{this.formatPrice(this.prices.minimalPrice.amount.value, this.prices.minimalPrice.amount.currency)}</span>
                    </div>
