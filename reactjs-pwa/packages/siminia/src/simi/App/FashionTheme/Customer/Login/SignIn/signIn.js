        ...
        return (
            <div className={`root sign-in-form ${Identify.isRtl() ? 'rtl-signInForm' : null}`}>
                <div className="error-login">
                    {Identify.__('Incorrect combination of user name and password.')}
                </div>
                <Form
                    className='form'
                ...
                >
                    ...
                    <div className='passwordInput wrap'>
                        <TextInputCustom
                    ...
                    <div className={`${Identify.isRtl() ? 'rtl-signInAction' : ''} signInAction`} >
