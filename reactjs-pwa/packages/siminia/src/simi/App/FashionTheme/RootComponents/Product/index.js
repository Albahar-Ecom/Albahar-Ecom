...
const Product = props => {
    ...
    if (sku)
        ...
        variables.urlKey = urlKeyItem ? urlKeyItem : getUrlKey();
        ...
        >
            {({ error, data }) => {
                ...
                if (product)
                    return (
                        <ProductFullDetail
                            product={product} isQuickView={isQuickView}
                        />
                    );
                return <Loading />
            }}
