...
import { simiUseMutation as useMutation, simiUseLazyQuery as useLazyQuery } from 'src/simi/Network/Query';
...
export const useCouponCode = props => {
    ...
    ] = useMutation(applyCouponMutation, {onError, onCompleted, errorPolicy: 'all'});
    ...
    ] = useMutation(removeCouponMutation, {onError, onCompleted, errorPolicy: 'all'});
